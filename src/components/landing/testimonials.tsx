...
const testimonials = [
  {
    name: "سارة الحسني",
    meta: "أم لطفلين — مشتركة منذ 3 أشهر — الرباط",
    text: "في كل أسبوع أفتح لوحة ولي الأمر وأرى بالضبط ما تعلمه ابني: اسم الدرس، النتيجة، المادة. هذا ما جعلني أجدد الاشتراك بدون تردد.",
  },
  {
    name: "عبدالله أوشن",
    meta: "الأب — فاس",
    text: "ابني في الإعدادي وكان يخسر وقتاً في يوتيوب. الآن ليلى تشرح له الدرس وتصحح أخطاءه. المعدل ارتفع بـ 12 نقطة في الفصل الثاني.",
  },
  {
    name: "فاطمة الزهراء",
    meta: "طالبة باكالوريا — الدار البيضاء",
    text: "عقول غيّر طريقة مذاكرتي. أستاذة ليلى تعرف بالضبط أين أحتاج مساعدة وتركّز عليها — بدون حكم ولا إحراج.",
  },
];
