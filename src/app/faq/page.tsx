...
const FAQS = [
  ...
  },
  {
    ...
    a: "نعم. عقول يغطي المنهج الرسمي للمملكة المغربية من السنة الأولى إلى السادسة ابتدائي، بما في ذلك اللغة العربية، الرياضيات، الفرنسية، والتربية الإسلامية.",
  },
  {
  ...
  },
  {
    ...
    a: "يستمر الحساب مفتوحاً على الخطة المجانية (طفل واحد، 30 دقيقة يومياً، المستوى الأول). لا يتم خصم أي مبلغ تلقائياً.",
  },
  {
